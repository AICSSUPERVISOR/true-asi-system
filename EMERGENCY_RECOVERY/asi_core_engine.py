...
API_KEYS = {
    ...
    "openai_1": os.getenv("OPENAI_API_KEY_1", "sk-proj-..."),
    "openai_2": os.getenv("OPENAI_API_KEY_2", "sk-proj-..."),
    "openai_3": os.getenv("OPENAI_API_KEY_3", "sk-proj-..."),
    ...
    # DeepSeek
    "deepseek": "sk-e13631fa38c54bf1bed97168e8fd6d9a",
